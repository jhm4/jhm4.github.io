...
def stocksplit(b): 
	...
	#feedback : didn't quite manage to get rid of the spaces in between the ratio numbers.  
	print(date)
	print("la")
	print(ratio)

stocksplit(list[len(list) - 1])

#magical initial date - June 9, 2014 so that the stock split is tested out. 
